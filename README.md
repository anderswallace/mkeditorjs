...
This code editor has a built in `show()` function. Write any JavaScript code and show output in the preview window by passing it to `show` as an argument. Make sure to include the following module at the top of your first code cell for proper execution:
```
